...
public class TestBase {
	...
	public TestBase()
	{
		...
		{
			prop = new Properties();
			FileInputStream fileinput = new FileInputStream("C://Users//Ashwini Raut//eclipse-workspace//com.practiceTest//src//main//java//resources//Properties//Properties.properties");
			prop.load(fileinput);
		}
		catch(IOException e)
		{
